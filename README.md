...
- While the website was made with the intentions to make it as user-friendly as pssoible, with a linear progression consisting of only back and forth movements——nothing can be guaranteed. Which is why the following guidelines will help to provide a short overview.
  1. Nearly everything is interactive<br>
     A majority of the elements (from the buttons, logos, and even profile pictures) have some sort of function. We encourage you to interact with as many things as possible!
  2. The responsiveness is lacking<br>
     As mentioned above, the resposiveness of the page doesn't support any other aspect ratio than a standard PC's 16:9 aspect ratio. While it still works and is functional, some elements may not appear correct, and as such it is encouraged to view this page on a PC.
